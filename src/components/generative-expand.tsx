...
const GenerativeExpand: FC = () => {
  return (
    <section className="flex flex-col items-center justify-center gap-3 mt-16">
      <div className="flex w-[90%] md:flex-row flex-col gap-10">
        <div className="md:w-[40%]">
          ...
          <p className="text-sm leading-[20px] font-normal text-[#ffffffcc]">
            Explore beyond the borders of your canvas with Generative Expand,
            make your image fit in any aspect without cropping the best parts.
            Just expand in any direction and the new content will blend
        ...
        <div className="md:w-[60%] pt-0 p-10">
          <div className="group relative flex min-h-[400px] items-center justify-center">
            <div className="relative flex justify-center items-center min-h-[600px] w-full">
              ...
              <img
                src={FrontImage}
                className="absolute z-4 md:w-[41.6666666%] h-auto rounded-3xl"
              />
            </div>
          </div>
        </div>
